...
| Component | File |
|-----------|------|
| Redis caching service (TTL, invalidation) | `backend/app/core/redis_cache.py` |
| PDF upload + Gemini AI extraction route | `backend/app/api/routes/ai_integration.py` |
| PDF retrieval route | `backend/app/api/routes/ai_integration.py` |
| Cache invalidation route | `backend/app/api/routes/ai_integration.py` |
| Config (REDIS_URL, PDF_CACHE_TTL_SECONDS) | `backend/app/core/config.py` |
| Unit tests (caching, hashing, XML) | `backend/tests/api/routes/test_pdf_extraction.py` |
| Integration tests (upload → retrieve flow) | `backend/tests/api/routes/test_pdf_extraction.py` |
| Performance tests | `backend/tests/performance/test_pdf_performance.py` |
